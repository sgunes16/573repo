...
class RemoveTrailingSlashMiddleware:
    ...
    Excludes admin URLs which require trailing slashes.
    """
    ...
    def __call__(self, request):
        # Remove trailing slash from path (except for root path and admin)
        # Admin URLs require trailing slashes to work properly
